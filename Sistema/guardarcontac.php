...
<!-- MAIN HEADER -->
 ...
 $mensaje = $_POST['mensaje'];
      ...
      if ($nombre=="" || $correo=="" || $telefo=="" || $asunto=="" || $mensaje=="")
      {
   ...
   (nombre_contacto,correo_contacto,telefono_contacto,asunto_contacto,mensaje_contacto) 
          values 
        ('$nombre','$correo','$telefo', '$asunto', '$mensaje')");
      }   
