...
<head>
  ...
  <meta http-equiv="refresh" content="6;url=http://localhost:8080/Proyectos/Lasstt/Sistema/mantenimientoproduc.php"/>
...
//$codigo=$_GET['id_Nproducto'];
 ...
 if(isset($_POST['btn_editar'])){
   $id_Nproducto = $_POST['id_Nproducto'];//no se modifica
 $nombp = $_POST['nombp'];
 $Precio= $_POST['Precio'];
 $cant= $_POST['cant'];
 $carac= $_POST['carac'];
...
if ($fot!=''){
$sql="update nuevosproductos set nombre_Nproducto='$nombp',precio_Nproducto='$Precio',cantidad_Nproducto='$cant',caracteristica_Nproducto='$carac',foto='$fot' where id_Nproducto='$id_Nproducto'";

  }else
  {

$sql="update nuevosproductos set nombre_Nproducto='$nombp', precio_Nproducto='$Precio', cantidad_Nproducto='$cant', caracteristica_Nproducto='$carac' where id_Nproducto='$id_Nproducto'";
}
...
if($resultado){
  //$codigo=mysql_insert_id($conexion);
       ...
       echo "<h3>Registro Editado con Exito</h3> <br>";
