...
$sql="Select * from detallepago where id='$codigo'";
...
//echo "Total de nuevos clientes :".$totalfilas."<br>";
	...
	echo "<table border='1' width='100%' height='100px'>";
			...
			echo "<td bgcolor='#FFFFFF'>id</center></td>";
					...
					echo "<td bgcolor='#FFFFFF'><center>id_compra</center></td>";
					echo "<td bgcolor='#FFFFFF'><center>nom_producto</center></td>";
					echo "<td bgcolor='#FFFFFF'><center>precio</center></td>";
					echo "<td bgcolor='#FFFFFF'><center>cantidad</center></td>";
