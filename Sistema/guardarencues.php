...
<head>
  ...
  <meta http-equiv="refresh" content="6;url=http://localhost:8080/Proyectos/Lasstt/Sistema/mantenimientoencues.php"/>
...
include ("Conexion.php");
 ...
 $buscarpr  = $_POST['buscarpr'];
 $informac = $_POST['informac'];
 $probabil= $_POST['probabil'];

 $errornav = $_POST['errornav'];

 $navegador = $_POST['navegador'];
 $calidadpr = $_POST['calidadpr'];
 $escala_en = $_POST['escala_en'];
 $tiempobus = $_POST['tiempobus'];
 $expectati = $_POST['expectati'];
 $tipopago = $_POST['tipopago'];
 $diseno = $_POST['diseno'];
 $resultadona = $_POST['resultadona'];
 $servicioadi = $_POST['servicioadi'];
 $procesobusq = $_POST['procesobusq'];
 $guianavegaci= $_POST['guianavegaci'];
 $recomendacio = $_POST['recomendacio'];        

      if ($buscarpr=="" || $informac=="" || $probabil=="" || $errornav=="" || $navegador=="" || $calidadpr=="" || $escala_en=="" || $tiempobus=="" || $expectati=="" || $tipopago=="" || $diseno=="" || $resultadona=="" || $servicioadi=="" || $procesobusq=="" || $guianavegaci=="" || $recomendacio=="")
      {
        echo "los campos son obligatorios";
      }
      else 
      {
        mysqli_query($conexion,"INSERT INTO encuesta 
        
   (buscarproducto_encuesta,informacionsegura_encuesta,probabilidadcompra_encuesta,errornavegador_encuesta,navegador4_encuesta,calidadproducto_encuesta,escala_encuesta,tiempobusqueda_encuesta,expectativas_encuesta,tipopago_encuesta,diseno_encuesta,resultadonavegacion_encuesta,servicioadicional_encuesta,procesobusqueda_encuesta,guianavegacion_encuesta,recomendacion_encuesta)
          values 
   ('$buscarpr','$informac','$probabil', '$errornav', '$navegador', '$calidadpr', '$escala_en', '$tiempobus', '$expectati', '$tipopago', '$diseno', '$resultadona', '$servicioadi', '$procesobusq', '$guianavegaci', '$recomendacio')");
      }   
