...
$codigo=$_GET['id_contacto'];

$sql="Select * from contacto where id_contacto='$codigo'";
...
<form action='mantenimientocontac.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="Actualizarcontac.php" enctype="multipart/form-data" >
                                ...
                                <fieldset>
                 				...
                 				<div class="form-group">
        									...
        									<input type="text" name="id_contacto" class="form-control"required placeholder="id_contacto" id="id_contacto" readonly value="<?php echo $filas['id_contacto'];?>">
  										  </div>
  										  </div>
                             
										<div class="form-group">
											 <div class="col-md-6">
     							   			<label for="nomb">nombre_usuario</label>
        									<input type="text" name="nomb" class="form-control"required placeholder="Tu nombre" id="nomb" value="<?php echo $filas['nombre_contacto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="correo">correo_contacto</label>
        									<input type="text" name="correo" class="form-control"required placeholder="Tu correo" id="correo" value="<?php echo $filas['correo_contacto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="telefo">telefono_contacto</label>
        									<input type="text" name="telefo" class="form-control"required placeholder="Tu telefono" id="telefo" value="<?php echo $filas['telefono_contacto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="asunto">asunto_contacto</label>
        									<input type="text" name="asunto" class="form-control"required placeholder="Tu asunto" id="asunto" value="<?php echo $filas['asunto_contacto'];?>">
  										  </div>
  										  </div>
  										   ...
  										   <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="mensaje">mensaje_contacto</label>
        									<input type="text" name="mensaje" class="form-control"required placeholder="Tu mensaje" id="mensaje" value="<?php echo $filas['mensaje_contacto'];?>">
  										  </div>
  										  </div>
