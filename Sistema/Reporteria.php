				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
					  <li ><a href="Listados.php">Listados</a></li>
						...
						<li class="active"><a href="Reporteria.php">Reporteria y Gráficos</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!--CUERPO-->
				<a href="ReporteUsuarios.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Usuarios"></a>
				<a href="ReporteClientes.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Clientes"></a>
				<a href="ReporteContactos.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Contactos"></a>
				<a href="ReporteNuevosProductos.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Nuevos Productos"></a>
				<a href="ReporteProductos.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Productos"></a>
				<a href="ReporteCarrito.php" target="_blank"><input type="button" class="btn btn-info" value="Reporte de Carrito"></a>
				<br>	<br><br>
		<h3>GRÁFICA DE CANTIDAD DE PRODUCTOS</h3><br>
		<center><img src="Grafica_Cantidad_Productos.php" alt="" border="0">
</center>
<h3>GRÁFICA DE ENCUESTA</h3><br>
		<center><img src="Grafica_Encuesta.php" alt="" border="0">
</center>
<h3>GRÁFICA DE TOP 5 PRODUCTOS</h3><br>
		<center><img src="Grafica_top5_Productos.php" alt="" border="0">
</center>
