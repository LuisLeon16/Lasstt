...
<form action='mantenimientouser.php'>
	...
	<form  method="POST" name="form-work" action="guardarusuario.php"  >
                 			...
                 			<div class="form-group">
        									...
        									<select class="form-control" name="rol" class="form-control" required placeholder="Tu rol" id="rol">
    ...
    <option value="2">Cliente</option>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="Email" class="form-control" required placeholder="Tu Email" id="Email">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="apell" class="form-control" required placeholder="Tu apellido" id="apell">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="cod" class="form-control" required placeholder="Tu cod" id="cod">
  										  </div>
  										  </div>
                           ...
                           <div class="form-group">
        									...
        									<input type="text" name="tele" class="form-control" required placeholder="Tu telefono" id="tele">
  										  </div>
  										  </div>
                           ...
                           <div class="form-group">
        									...
        									<input type="text" name="direcc" class="form-control" required placeholder="Tu direccion" id="direcc">
  										  </div>
  										  </div>
