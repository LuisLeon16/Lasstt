		...
		<nav id="navigation">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<li class="active"><a href="mantenimientocontac.php">Mantenimientos de Contacto</a></li>
...
$sql="Select * from contacto where estado ='A'";
$consulta=mysqli_query($conexion,$sql);

$totalfilas=mysqli_num_rows($consulta);
//echo "Total de nuevos clientes :".$totalfilas."<br>";
	echo "<tr>";
echo "<form action='nuevoscontac.php'>";
echo "<td><input type='submit' value='Registrar' class='btn btn-primary' name='btn_registrar'> Total de Contactos :".$totalfilas."<br></td>";
echo "</form><hr>";
	echo "<table border='1' width='100%' height='200px'>";
					...
					echo "<tr>";
					echo "<td bgcolor='#FFFFFF'><center>id_contacto</center></td>";
...
while ($filas=mysqli_fetch_array($consulta)) {
	echo "<tr>";
	echo "<td><center>".$filas['id_contacto']."</center></td>";
...
//consultar
$ver='window.open("consultarcontac.php?id_contacto='.$filas['id_contacto'].'","Detalle", "width=1000, height=400,left=100,top=150,menubar=no,scrollbars=no,fullscreen=no,toolbar=no,status=no");';
echo"<td>&nbsp<a class='btn btn-success' href='#' onclick='".$ver."'>consultar</td>";



//actualizar
echo"<td>&nbsp<a class='btn btn-info' href='editarcontac.php?id_contacto=".$filas['id_contacto']."'>Actualizar</td>";


//eliminar
$eli='return confirm("Estas seguro que quieres eliminar este cliente?")';
echo"<td>&nbsp<a class='btn btn-danger' href='eliminarcontac.php?id_contacto=".$filas['id_contacto']."'onclick='".$eli."'>Eliminar</td>";
