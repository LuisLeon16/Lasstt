...
<form action='mantenimientocontac.php'>
	...
	<form  method="POST" name="form-work" action="guardarcontac.php"  >
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="telefo" class="form-control"required placeholder="Tu telefono" id="telefo">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="asunto" class="form-control"required placeholder="Tu asunto" id="asunto">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="mensaje" class="form-control"required placeholder="Tu mensaje" id="mensaje">
  										  </div>
  										  </div>
