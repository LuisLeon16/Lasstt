				...
				<li class="submenu">
					...
					<ul class="children">
					  <li style="text-align: rigth;"><a href="Listados.php">Listados</a></li>
						<li style="text-align: rigth;"><a href="Nuevosproductos.php">Nuevos Productos</a></li>
...
<h1>Insertar nuevos productos</h1><hr>
<form action='mantenimientoproduc.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="guardarprodu.php" enctype="multipart/form-data" >
                             ...
                             <!--<div class="form-group">
        									...
        									<input type="text" name="id" class="form-control"required placeholder="Tu id" id="id">
  										  </div>
  										  </div>-->

										<div class="form-group">
											 <div class="col-md-6">
     							   			<label for="nombp">Nombre del producto</label>
        									<input type="text" name="nombp" class="form-control"required placeholder="Nombre del producto" id="nombp">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="cant" class="form-control"required placeholder="Cantidad" id="cant">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="carac">Caracteristica adicional</label>
        									<input type="text" name="carac" class="form-control"required placeholder="Características" id="carac">
  										  </div>
  										  </div>
											 ...
											 <div class="col-md-6">
     							   			...
     							   			<td><input class="form-control" type="file" name="fot" required id="fot"></td>
  										  </div>
  										  </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <center><input type="submit" value="Registrar" class="btn btn-primary" name="btn_registrar" ></center>
