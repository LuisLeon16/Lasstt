		...
		<nav id="navigation">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<li class="active"><a href="mantenimientouser.php">Mantenimientos de Usuarios</a></li>
...
//echo "Total de nuevos clientes :".$totalfilas."<br>";
	echo "<tr>";
echo "<form action='nuevosuser.php'>";
echo "<td><input type='submit' value='Registrar' class='btn btn-primary' name='btn_registrar'> Total de usuarios :".$totalfilas."<br></td>";
echo "</form><hr>";
	echo "<table border='1' width='100%' height='400px'>";
...
//consultar
$ver='window.open("consultaruser.php?id='.$filas['id'].'","Detalle", "width=1000, height=500,left=100,top=150,menubar=no,scrollbars=no,fullscreen=no,toolbar=no,status=no");';
echo"<td>&nbsp<a class='btn btn-success' href='#' onclick='".$ver."'>consultar</td>";



//actualizar
echo"<td>&nbsp<a class='btn btn-info' href='editaruser.php?id=".$filas['id']."'>Actualizar</td>";


//eliminar
$eli='return confirm("Estas seguro que quieres eliminar este usuario?")';
echo"<td>&nbsp<a class='btn btn-danger' href='eliminaruser.php?id=".$filas['id']."'onclick='".$eli."'>Eliminar</td>";
