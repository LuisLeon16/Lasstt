...
<head>
  ...
  <meta http-equiv="refresh" content="6;url=http://localhost:8080/Proyectos/Lasstt/Sistema/mantenimientoclien.php"/>
...
<!-- MAIN HEADER -->
 ...
 if(isset($_POST['btn_editar'])){
   $id_cliente= $_POST['id_cliente'];//no se modifica
 $nomb  = $_POST['nomb'];
 $ape  = $_POST['ape'];
 $contra= $_POST['contra'];
 $correo = $_POST['correo'];
...
$sql="Update cliente set nombre_cliente='$nomb', apellido_cliente='$ape', contra_cliente='$contra', correo_cliente='$correo', telefono_cliente='$telefo', codpostal_cliente='$codpos', direccion_cliente='$direcc', tarjetacredito_cliente='$tarjet', fechanac_cliente='$fechan', codigocvv_cliente='$codigo'  where id_cliente='$id_cliente'";
