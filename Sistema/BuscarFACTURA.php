...
<!-- MAIN HEADER -->
 ...
 <div class="formulario">
     <a href="detalle.php" class="btn btn-danger">Regresar</a>
     <br>     <br>

     
		<label for="caja_busqueda">Buscar</label>
		<input type="text" name="caja_busqueda" id="caja_busqueda" class="search_input" placeholder="Digite el registro a buscar" style="width: 50%;"></input>
	</div>
