...
<head>
 ...
 <meta http-equiv="refresh" content="6;url=http://localhost:8080/Proyectos/Lasstt/Sistema/mantenimientocontac.php"/>
...
<!-- MAIN HEADER -->
 ...
 if(isset($_POST['btn_editar'])){
   $id_contacto= $_POST['id_contacto'];//no se modifica
 $nomb = $_POST['nomb'];
 $correo= $_POST['correo'];
 $telefo = $_POST['telefo'];
 $asunto = $_POST['asunto'];
...
$sql="Update contacto set nombre_contacto='$nomb', correo_contacto='$correo', telefono_contacto='$telefo', asunto_contacto='$asunto', mensaje_contacto='$mensaje' where id_contacto='$id_contacto'";
