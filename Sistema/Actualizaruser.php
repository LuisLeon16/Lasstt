...
$sql="Update usuario set RolUsuario='$rol', NombreUsuario='$nomb', Contrasena='$Contra', EmailUsuario='$Email', apellidos_usuario='$apell', codigoPos_usuario='$cod', telefono_usuario='$tele', direccion_usuario='$direcc' where id='$id'";
