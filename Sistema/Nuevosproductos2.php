...
<h1>Insertar productos</h1><hr>
<form action='mantenimientoproduc.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="guardarprodu2.php" enctype="multipart/form-data" >
                 	...
                 	<div class="form-group">
										...
										<div class="form-group">
        									...
        									<input type="text" name="producto" class="form-control"required placeholder="Nombre producto" id="producto">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="existencia" class="form-control"required placeholder="Existencia" id="existencia">
  										  </div>
  										  </div>
