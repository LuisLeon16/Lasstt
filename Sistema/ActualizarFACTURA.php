...
<head>
  ...
  <meta http-equiv="refresh" content="6;url=http://localhost:8080/Proyectos/Lasstt/Sistema/detalle.php?"/>
...
<!-- MAIN HEADER -->
 ...
 if(isset($_POST['btn_editar'])){
   $id=$_POST['id'];//no se modifica
     
 $id_suario=$_POST['id_suario'];
 $fecha_compra=$_POST['fecha_compra'];
 $valor=$_POST['valor'];
 $tipo_tj=$_POST['tipo_tj'];
 $nombre_tj=$_POST['nombre_tj'];
 $banco_e=$_POST['banco_e'];
 $num_tj=$_POST['num_tj'];
 $mes_tj=$_POST['mes_tj'];
 $year_tj=$_POST['year_tj'];
 $Estado=$_POST['Estado'];



$sql="Update pago set id_suario='$id_suario', fecha_compra='$fecha_compra', valor='$valor', tipo_tj='$tipo_tj', nombre_tj='$nombre_tj', banco_e='$banco_e', num_tj='$num_tj', mes_tj='$mes_tj', year_tj='$year_tj',Estado='$Estado'  where id='$id'";
...
if($consulta){
  ...
  echo "<h3>Registro Actualizado con Exito</h3> <br>";
  echo "<img src='Imagenes_LASSTT/wait.gif' width='750' height='400'/>";
}
     else 
    echo "<h3>Registro no Actualizado </h3> <br>";
