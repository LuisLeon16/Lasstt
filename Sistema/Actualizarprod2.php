...
<head>
  ...
  <meta http-equiv="refresh" content="6;url=https://esdis.net/Sistema/mantenimientoproduc.php"/>
...
if ($fot!=''){
$sql="update productos set producto='$producto',precio='$precio',existencia='$existencia',foto='$fot' where id='$id'";

  }else
  {

$sql="update productos set producto='$producto',precio='$precio',existencia='$existencia' where id='$id'";
}
