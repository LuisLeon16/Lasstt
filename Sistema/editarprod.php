...
$codigo=$_GET['id_Nproducto'];

$sql="Select * from nuevosproductos where id_Nproducto='$codigo'";
...
<h1>Modificar nuevos datos</h1><hr>
	<form action='mantenimientoproduc.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="Actualizarprod.php" enctype="multipart/form-data" >
                    
                                <fieldset>

                 	<div class="form-group">
											 <div class="col-md-6">
     							   			<label for="id_Nproducto">id_Nproducto</label>
        									<input type="text" name="id_Nproducto" class="form-control"required placeholder=" id" id="id_Nproducto" readonly value="<?php echo $filas['id_Nproducto'];?>">
  										  </div>
  										  </div>

										<div class="form-group">
											 <div class="col-md-6">
     							   			<label for="nombp">nombre_Nproducto</label>
        									<input type="text" name="nombp" class="form-control"required placeholder="nombre producto" id="nombp" value="<?php echo $filas['nombre_Nproducto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="Precio">precio_Nproducto</label>
        									<input type="text" name="Precio" class="form-control"required placeholder="Tu Precio" id="Precio" value="<?php echo $filas['precio_Nproducto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="cant">cantidad_Nproductoc</label>
        									<input type="text" name="cant" class="form-control"required placeholder="cantidad" id="cant" value="<?php echo $filas['cantidad_Nproducto'];?>">
  										  </div>
  										  </div>

                          <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="carac">caracteristica_Nproducto</label>
        									<input type="text" name="carac" class="form-control"required placeholder="características" id="carac" value="<?php echo $filas['caracteristica_Nproducto'];?>">
  										  </div>

  										   <div class="form-group">
											 <div class="col-md-6">
     							   			<label for="fot">Foto</label>
     							   			<td><input class="form-control" type="file" name="fot" id="fot"></td>
  										  </div>
  										  </div>
