...
<?php
 ...
 $codigo = $_POST['codigo'];
      ...
      if ($nombre=="" || $ape=="" || $contra=="" || $correo=="" || $telefo=="" || $codpos=="" || $direcc=="" || $tarjet=="" || $fechan=="" || $codigo=="")
      {
   ...
   (nombre_cliente,apellido_cliente,contra_cliente,correo_cliente,telefono_cliente,codpostal_cliente,direccion_cliente,tarjetacredito_cliente,fechanac_cliente,codigocvv_cliente) 
          values 
        ('$nombre','$ape','$contra', '$correo', '$telefo', '$codpos', '$direcc', '$tarjet', '$fechan', '$codigo')");
      }   
