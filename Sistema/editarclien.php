...
<h1>Modificar nuevos CLientes</h1><hr>
	<form action='mantenimientoclien.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="Actualizarclien.php" enctype="multipart/form-data" >
                                              <fieldset>

                 		<div class="form-group">
											 <div class="col-md-6">
     							   			<label for="id_cliente">id cliente</label>
        									<input type="text" name="id_cliente" class="form-control"required placeholder="id_cliente" id="id_cliente" readonly value="<?php echo $filas['id_cliente'];?>">
  										  </div>
  										  </div>
										...
										<div class="form-group">
        									...
        									<input type="text" name="nomb" class="form-control"required placeholder="Tu nombre" id="nomb" value="<?php echo $filas['nombre_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="ape" class="form-control"required placeholder="Tu apellido" id="ape" value="<?php echo $filas['apellido_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="contra" class="form-control"required placeholder="Tu contra" id="contra" value="<?php echo $filas['contra_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="correo" class="form-control"required placeholder="Tu correo" id="correo" value="<?php echo $filas['correo_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="telefo" class="form-control"required placeholder="Tu telefo" id="telefo" value="<?php echo $filas['telefono_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="codpos" class="form-control"required placeholder="Tu codpos" id="codpos" value="<?php echo $filas['codpostal_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="direcc" class="form-control"required placeholder="Tu direcc" id="direcc" value="<?php echo $filas['direccion_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="tarjet" class="form-control"required placeholder="Tu tarjet" id="tarjet" value="<?php echo $filas['direccion_cliente'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="date" name="fechan" class="form-control"required placeholder="Tu fechan" id="fechan" value="<?php echo $filas['fechanac_cliente'];?>" style="width: 31%">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="codigo" class="form-control"required placeholder="Tu codigo" id="codigo" value="<?php echo $filas['codigocvv_cliente'];?>">
  										  </div>
  										  </div>
