...
?>
<h1>Modificar datos</h1><hr>
	<form action='mantenimientoproduc.php'>
	<input type="submit" value="Regresar" class="btn btn-success">
		</form>
	<form  method="POST" name="form-work" action="Actualizarprod2.php" enctype="multipart/form-data" >
                 	...
                 	<div class="form-group">
										...
										<div class="form-group">
        									...
        									<input type="text" name="producto" class="form-control"required placeholder="Nombre producto" id="producto" value="<?php echo $filas['producto'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="precio" class="form-control"required placeholder="Precio" id="precio" value="<?php echo $filas['precio'];?>">
  										  </div>
  										  </div>
                          ...
                          <div class="form-group">
        									...
        									<input type="text" name="existencia" class="form-control"required placeholder="Existencia" id="existencia" value="<?php echo $filas['existencia'];?>">
  										  </div>
  										  </div>
